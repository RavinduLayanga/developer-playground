/*
 * HackerRank DSA: Dynamic Array problem
 * 
 ...
 * 
 * The main class name was changed from 'Solution' to 'DynamicArrayProblem'
    ...
    public static List<Integer> dynamicArray(int n, List<List<Integer>> queries) {
        ...
        for (List<Integer> query : queries) {
            ...
            if (type == 1) {
                ...
                List<Integer> targetList = arr.get(idx);
                int size = targetList.size();
                int elementIndex = y % size;
                lastAnswer = targetList.get(elementIndex);
